...
// appends it to servers.txt, wipes the file if it grows past 500 KB,
// and renders the whole list as a table with line numbers.
declare(strict_types=1);

const FILE_PATH       = __DIR__ . '/servers.txt';
...
<body>
  <div class="wrap">
    ...
    <?php if (count($lines) === 0): ?>
      <p class="empty">servers.txt is empty.</p>
    <?php else: ?>
      <table>
        <thead>
